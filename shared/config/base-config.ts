...
export function createConfig(opts: SiteConfig): Config {
  return {
    ...
    // Cookieless analytics — the inline script sets the endpoint the
    // analytics.ts client module posts to. No cookies, no consent gate.
    headTags: [
      {
        tagName: 'script',
        attributes: {},
    ...
    themeConfig: {
      ...
      navbar: {
        ...
        logo: {
          ...
          ...(SITE_ICONS[opts.site]?.logoDark ? { srcDark: SITE_ICONS[opts.site].logoDark } : {}),
        },
        items: [
          ...(opts.navbarItems || []),
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: "Technical Blog", href: "https://orb.almadar.io/blog" },
