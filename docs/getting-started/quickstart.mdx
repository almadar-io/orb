    ...
    "traits": [{
      ...
      "stateMachine": {
        ...
        "transitions": [
          ...
          { "from": "Creating", "event": "SAVE", "to": "Listing", "effects": [["render-ui", "modal", null], ["fetch", "Task"], ["render-ui", "main", { "type": "stack", "direction": "vertical", "gap": "lg", "children": [{ "type": "typography", "content": "My Task Manager", "variant": "h2" }, { "type": "divider" }, { "type": "data-list", "entity": "Task", "fields": ["title", "status"] }] }]] },
          { "from": "Creating", "event": "CANCEL", "to": "Listing", "effects": [["render-ui", "modal", null], ["render-ui", "main", { "type": "stack", "direction": "vertical", "gap": "lg", "children": [{ "type": "typography", "content": "My Task Manager", "variant": "h2" }, { "type": "divider" }, { "type": "data-list", "entity": "Task", "fields": ["title", "status"] }] }]] },
          { "from": "Listing", "event": "EDIT", "to": "Editing" },
          { "from": "Editing", "event": "SAVE", "to": "Listing", "effects": [["render-ui", "modal", null], ["fetch", "Task"], ["render-ui", "main", { "type": "stack", "direction": "vertical", "gap": "lg", "children": [{ "type": "typography", "content": "My Task Manager", "variant": "h2" }, { "type": "divider" }, { "type": "data-list", "entity": "Task", "fields": ["title", "status"] }] }]] },
          { "from": "Editing", "event": "CANCEL", "to": "Listing", "effects": [["render-ui", "modal", null], ["render-ui", "main", { "type": "stack", "direction": "vertical", "gap": "lg", "children": [{ "type": "typography", "content": "My Task Manager", "variant": "h2" }, { "type": "divider" }, { "type": "data-list", "entity": "Task", "fields": ["title", "status"] }] }]] },
