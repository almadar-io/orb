...
import quickstartSchema from './quickstart.orb.json';
...
<OrbPreviewBlock schema={JSON.stringify(quickstartSchema)} showCode={false} />
...
- [Core Concepts: Entities](/docs/core-concepts/entities) to learn about entity types and fields
- [Core Concepts: Traits](/docs/core-concepts/traits) for a deep dive into state machines
