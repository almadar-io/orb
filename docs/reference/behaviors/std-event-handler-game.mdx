---
id: std-event-handler-game
title: "std-event-handler-game"
sidebar_label: "std-event-handler-game"
description: "EventHandlerGameOrbital behavior with 3 states, 5 events, and 5 transitions."
---
...
**Level**: Molecule | **Entity**: EventHandlerGame | **Persistence**: runtime
...
<OrbPreviewBlock schema={`{
  "name": "EventHandlerGameOrbital",
  "orbitals": [
    {
      "name": "EventHandlerGameOrbital",
      "entity": {
        "name": "EventHandlerGame",
        "persistence": "runtime",
        "fields": [
          {
            "name": "id",
      ...
      "traits": [
        {
          "name": "EventHandlerGameEventHandlerGame",
          "linkedEntity": "EventHandlerGame",
      ...
      "pages": [
        {
          "name": "EventHandlerGamePage",
          "path": "/eventhandlergames",
          "traits": [
            {
              "ref": "EventHandlerGameEventHandlerGame"
            }
          ]
        }
      ]
