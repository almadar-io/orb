---
id: std-debugger-game
title: "std-debugger-game"
sidebar_label: "std-debugger-game"
description: "DebuggerGameOrbital behavior with 3 states, 5 events, and 5 transitions."
---
...
**Level**: Molecule | **Entity**: DebuggerGame | **Persistence**: runtime
  ...
  "orbitals": [
    {
      ...
      "traits": [
        {
          "name": "DebuggerGameDebuggerGame",
          "linkedEntity": "DebuggerGame",
      ...
      "pages": [
        {
          "name": "DebuggerGamePage",
          "path": "/debuggergames",
          "traits": [
            {
              "ref": "DebuggerGameDebuggerGame"
            }
          ]
        }
      ]
