...
- [المفاهيم الأساسية: الكيانات](/docs/core-concepts/entities) للتعرف على أنواع الكيانات والحقول
- [المفاهيم الأساسية: السمات](/docs/core-concepts/traits) للتعمق في آلات الحالة
- [بناء مدير مهام (تعليمي)](/docs/tutorials/beginner/task-manager) لشرح تفصيلي أكثر مع سمات متعددة
