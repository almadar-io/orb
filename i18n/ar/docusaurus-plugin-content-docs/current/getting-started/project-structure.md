...
- [المفاهيم الأساسية: الكيانات](/docs/core-concepts/entities) لأنواع الحقول، أوضاع الاستمرارية، والعلاقات
- [المفاهيم الأساسية: السمات](/docs/core-concepts/traits) لآلات الحالة، الحراس، والتأثيرات
- [المفاهيم الأساسية: الصفحات](/docs/core-concepts/pages) للتوجيه وتركيب السمات
