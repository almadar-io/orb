...
- [Kljucni koncepti: Entitete](/docs/core-concepts/entities) za spoznavanje tipov entitet in polj
- [Kljucni koncepti: Lastnosti](/docs/core-concepts/traits) za poglobitev v avtomate stanj
